    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {
        ...
        try
        {
            ...
            else if(jTextField4.getText().equals(jTextField5.getText()))
            {
                ...
                String sql="insert into customer (Name,Phone_no,Address,Username,Password) values('"+jTextField1.getText()+"','"+jTextField2.getText()+"','"+
                            jTextArea1.getText()+"','"+jTextField3.getText()+"','"+jTextField4.getText()+"');";
